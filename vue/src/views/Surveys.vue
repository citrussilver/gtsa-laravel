    ...
    <PageComponent>
      ...
      <!-- <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 md:grid-cols-3">
        <div
          ...
          :key="survey.id"
          class="flex flex-col py-6 px-6 shadow-md bg-white hover:bg-gray-50 h-[470px]"
        >
          <img :src="survey.image" alt="" class="w-full h-48 object-cover" />
          <h4 class="mt-4 text-lg font-bold">{{ survey.title }}</h4>
          <div v-bind="survey.description" class="overflow-hidden flex-1">
          ...
          <div class="flex justify-between items-center mt-3">
              ...
              <button
                ...
                class="
                  ...
                  border-transparent text-sm text-red-500 
